 ...
 */
export function populateToolDisplay({ name, invocation, resultDisplay, displayName, }) {
    const display = {
 ...
 */
export function toolResultDisplayToDisplayContent(resultDisplay) {
 ...
 */
export function renderDisplayDiff(diff) {
    return Diff.createPatch(diff.path || 'file', diff.beforeText, diff.afterText, 'Original', 'Modified', { context: 3 });
}
/**
 ...
 */
export function displayContentToString(display) {
    if (!display) {
        return undefined;
    }
...
//# sourceMappingURL=tool-display-utils.js.map
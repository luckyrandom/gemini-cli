    ...
    async *stream(options = {}) {
        ...
        try {
            ...
            if (options.eventId) {
                ...
                const index = currentEvents.findIndex((e) => e.type === 'agent_start' && e.streamId === options.streamId);
                if (index !== -1) {
                ...
                for (let i = activeStarts.length - 1; i >= 0; i--) {
                    ...
                    if (!currentEvents.some((e) => e.type === 'agent_end' && e.streamId === start.streamId)) {

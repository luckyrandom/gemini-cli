 ...
 */
export function getSecureSanitizationConfig(requestedConfig = {}, baseConfig) {
    const allowed = [
    ...
    return {
        ...
        enableEnvironmentVariableRedaction: requestedConfig.enableEnvironmentVariableRedaction ??

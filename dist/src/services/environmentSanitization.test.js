...
import { ALWAYS_ALLOWED_ENVIRONMENT_VARIABLES, NEVER_ALLOWED_ENVIRONMENT_VARIABLES, NEVER_ALLOWED_NAME_PATTERNS, NEVER_ALLOWED_VALUE_PATTERNS, sanitizeEnvironment, getSecureSanitizationConfig, } from './environmentSanitization.js';
const EMPTY_OPTIONS = {
...
describe('getSecureSanitizationConfig', () => {
    ...
    it('should filter out variables from allowed list that match NEVER_ALLOWED_ENVIRONMENT_VARIABLES', () => {
        ...
        expect(config.allowedEnvironmentVariables).not.toContain('GOOGLE_CLOUD_PROJECT');
    });

...
describe('FileDiscoveryService', () => {
    ...
    describe('initialization', () => {
        ...
        it('should call applyFilterFilesOptions in constructor', () => {
            ...
            FileDiscoveryService.prototype, 'applyFilterFilesOptions');
    ...
    describe('shouldIgnoreFile & shouldIgnoreDirectory', () => {
        ...
        it('should return true for git-ignored directories', () => {
            const service = new FileDiscoveryService(projectRoot);
            expect(service.shouldIgnoreDirectory(path.join(projectRoot, 'node_modules'))).toBe(true);
        });
    ...
    describe('getIgnoredPaths', () => {
        ...
        it('should optimize by not traversing into ignored directories', async () => {
            ...
            const service = new FileDiscoveryService(projectRoot);
            const ignoredPaths = await service.getIgnoredPaths();
            expect(ignoredPaths.sort()).toEqual([path.join(projectRoot, '.git'), ignoredDir].sort());
        });
        it('should handle un-ignore patterns correctly', async () => {
            ...
            expect(ignoredPaths).not.toContain(path.join(projectRoot, 'ignored-dir/keep.txt'));
        ...
        it('should respect FilterFilesOptions when provided', async () => {
            ...
            expect(onlyGemini).toContain(path.join(projectRoot, 'ignored-by-gemini.txt'));
            ...
            expect(onlyGit).not.toContain(path.join(projectRoot, 'ignored-by-gemini.txt'));
        });
    });
});

...
export function updateGlobalFetchTimeouts(timeoutMs) {
 ...
 */
function isBenchmarkAddress(addr) {
 ...
 */
export function isAddressPrivate(address) {
 ...
 */
export async function isPrivateIpAsync(url) {
    try {
 ...
 */
export function createSafeProxyAgent(proxyUrl) {

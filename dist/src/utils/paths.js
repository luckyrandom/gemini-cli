 ...
 */
export function resolveToRealPath(pathStr) {
...
function robustRealpath(p, visited = new Set()) {
 ...
 */
export function deduplicateAbsolutePaths(paths) {

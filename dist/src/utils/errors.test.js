...
import { isAuthenticationError, isAbortError, UnauthorizedError, toFriendlyError, BadRequestError, ForbiddenError, AccountSuspendedError, getErrorMessage, getErrorType, FatalAuthenticationError, FatalCancellationError, FatalInputError, FatalSandboxError, FatalConfigError, FatalTurnLimitedError, FatalToolExecutionError, } from './errors.js';
...
describe('toFriendlyError', () => {
    ...
    it('should return AccountSuspendedError for 403 with TOS_VIOLATION reason in details', () => {
        ...
        expect(suspended.message).toBe('This service has been disabled in this account for violation of Terms of Service.');
...
describe('getErrorType', () => {
    ...
    it('should return constructor name for custom errors', () => {
        expect(getErrorType(new FatalAuthenticationError('test'))).toBe('FatalAuthenticationError');
        ...
        expect(getErrorType(new FatalTurnLimitedError('test'))).toBe('FatalTurnLimitedError');
        expect(getErrorType(new FatalToolExecutionError('test'))).toBe('FatalToolExecutionError');
        expect(getErrorType(new FatalCancellationError('test'))).toBe('FatalCancellationError');
        expect(getErrorType(new ForbiddenError('test'))).toBe('ForbiddenError');
        expect(getErrorType(new AccountSuspendedError('test'))).toBe('AccountSuspendedError');

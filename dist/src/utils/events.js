...
(function (CoreEvent) {
    ...
    CoreEvent["HookSystemMessage"] = "hook-system-message";
    ...
    CoreEvent["McpProgress"] = "mcp-progress";
    ...
    _emitOrQueue(event, ...args) {
        if (this.listenerCount(event) === 0) {
            ...
            if (backlogSize >= CoreEventEmitter.MAX_BACKLOG_SIZE) {
                ...
                this._eventBacklog[this._backlogHead] = undefined;
                this._backlogHead++;

 ...
 */
export declare function processImports(content: string, basePath: string, debugMode?: boolean, importState?: ImportState, projectRoot?: string, importFormat?: 'flat' | 'tree', boundaryMarkers?: readonly string[]): Promise<ProcessImportsResult>;

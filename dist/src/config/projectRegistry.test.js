...
describe('ProjectRegistry', () => {
    ...
    it('throws on lock timeout', async () => {
        ...
        expect(lock).toHaveBeenCalledWith(registryPath, expect.objectContaining({
    ...
    it('protects against data destruction by throwing on EACCES instead of resetting', async () => {
        ...
        readFileSpy.mockRejectedValue(Object.assign(new Error('Permission denied'), { code: 'EACCES' }));

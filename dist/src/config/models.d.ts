...
export interface IModelConfigService {
    ...
    resolveClassifierModelId(tier: string, requestedModel: string, context?: ModelResolutionContext): string;
}
/**
...
export declare const PREVIEW_GEMINI_3_1_FLASH_LITE_MODEL = "gemini-3.1-flash-lite-preview";
 ...
 */
export declare function resolveModel(requestedModel: string, useGemini3_1?: boolean, useGemini3_1FlashLite?: boolean, useCustomToolModel?: boolean, hasAccessToPreview?: boolean, config?: ModelCapabilityContext): string;
/**
 ...
 * @returns The resolved concrete model name.
 */
export declare function resolveClassifierModel(requestedModel: string, modelAlias: string, useGemini3_1?: boolean, useGemini3_1FlashLite?: boolean, useCustomToolModel?: boolean, hasAccessToPreview?: boolean, config?: ModelCapabilityContext): string;
export declare function getDisplayString(model: string, config?: ModelCapabilityContext): string;
/**
 ...
 */
export declare function isPreviewModel(model: string, config?: ModelCapabilityContext): boolean;
/**
 ...
 */
export declare function isProModel(model: string, config?: ModelCapabilityContext): boolean;
/**
 ...
 */
export declare function isGemini3Model(model: string, config?: ModelCapabilityContext): boolean;
/**
 ...
 */
export declare function isCustomModel(model: string, config?: ModelCapabilityContext): boolean;
/**
 ...
 */
export declare function isAutoModel(model: string, config?: ModelCapabilityContext): boolean;
/**
 ...
 */
export declare function supportsMultimodalFunctionResponse(model: string, config?: ModelCapabilityContext): boolean;
/**
 ...
 */
export declare function isActiveModel(model: string, useGemini3_1?: boolean, useGemini3_1FlashLite?: boolean, useCustomToolModel?: boolean): boolean;

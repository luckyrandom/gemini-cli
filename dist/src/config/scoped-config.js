 ...
 */
export function getWorkspaceContextOverride() {
 ...
 */
export function runWithScopedWorkspaceContext(scopedContext, fn) {
 ...
 */
export function createScopedWorkspaceContext(parentContext, additionalDirectories) {
...
//# sourceMappingURL=scoped-config.js.map
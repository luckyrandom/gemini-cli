...
export async function recordConversationOffered(server, traceId, response, streamingLatency, abortSignal, trajectoryId) {
    try {
        if (traceId) {
...
export function createConversationOffered(response, traceId, signal, streamingLatency, trajectoryId) {

...
describe('telemetry', () => {
    describe('createConversationOffered', () => {
        it('should create a ConversationOffered object with correct values', () => {
            ...
            ], true, [{ name: 'replace', args: {} }]);
            const traceId = 'test-trace-id';
            const streamingLatency = { totalLatency: '1s' };
            const result = createConversationOffered(response, traceId, undefined, streamingLatency, 'trajectory-id');
        ...
        it('should return undefined if no function calls', () => {
            ...
            const result = createConversationOffered(response, 'trace-id', undefined, {}, 'trajectory-id');
        ...
        it('should set status to CANCELLED if signal is aborted', () => {
            ...
            const result = createConversationOffered(response, 'trace-id', signal, {}, 'trajectory-id');
        ...
        it('should set status to EMPTY if candidates is empty', () => {
            ...
            const result = createConversationOffered(response, 'trace-id', undefined, {}, undefined);
        ...
        it('should detect code in response', () => {
            ...
            const result = createConversationOffered(response, 'id', undefined, {}, undefined);
    ...
    describe('recordConversationOffered', () => {
        it('should call server.recordConversationOffered if traceId is present', async () => {
            ...
            await recordConversationOffered(serverMock, 'trace-id', response, streamingLatency, undefined, undefined);
        ...
        it('should not call server.recordConversationOffered if traceId is undefined', async () => {
            ...
            await recordConversationOffered(serverMock, undefined, response, {}, undefined, undefined);
    ...
    describe('recordToolCallInteractions', () => {
        ...
        it('should record ACCEPT_FILE interaction for accepted edit tools', async () => {
            ...
            expect(mockServer.recordConversationInteraction).toHaveBeenCalledWith(expect.objectContaining({
                traceId: 'trace-1',
                status: ActionStatus.ACTION_STATUS_NO_ERROR,

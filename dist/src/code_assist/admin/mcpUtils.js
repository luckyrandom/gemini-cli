 ...
 */
export function applyAdminAllowlist(localMcpServers, adminAllowlist) {
    ...
    for (const [serverId, localConfig] of Object.entries(localMcpServers)) {
        ...
        if (adminConfig) {
            ...
            if ((adminConfig.includeTools && adminConfig.includeTools.length > 0) ||
 ...
 */
export function applyRequiredServers(mcpServers, requiredServers) {
    ...
    for (const [serverId, requiredConfig] of Object.entries(requiredServers)) {
        ...
        result[serverId] = new MCPServerConfig(undefined, // command (stdio not supported for required servers)
        undefined, // args
        undefined, // env
        undefined, // cwd
...
//# sourceMappingURL=mcpUtils.js.map
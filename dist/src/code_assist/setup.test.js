...
import { ProjectIdRequiredError, setupUser, ValidationCancelledError, resetUserDataCacheForTesting, } from './setup.js';
import { ValidationRequiredError } from '../utils/googleQuotaErrors.js';
import { CodeAssistServer } from '../code_assist/server.js';
import { UserTierId } from './types.js';
import { logOnboardingSuccess, OnboardingSuccessEvent, } from '../telemetry/index.js';
...
describe('setupUser', () => {
    ...
    describe('new user', () => {
        it('should onboard a new paid user with GOOGLE_CLOUD_PROJECT', async () => {
            ...
            const userDataPromise = setupUser({}, mockConfig);
            ...
            expect(logOnboardingSuccess).toHaveBeenCalledWith(mockConfig, expect.any(OnboardingSuccessEvent));

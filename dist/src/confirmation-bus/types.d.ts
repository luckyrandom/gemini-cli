...
import type { ToolConfirmationOutcome, ToolConfirmationPayload, DiffStat } from '../tools/tools.js';
...
export type Message = ToolConfirmationRequest | ToolConfirmationResponse | ToolPolicyRejection | ToolExecutionSuccess | ToolExecutionFailure | UpdatePolicy | AskUserRequest | AskUserResponse | ToolCallsUpdateMessage | SubagentActivityMessage;

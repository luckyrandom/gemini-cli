...
import { sanitizeExtractedPath, } from '../utils/sandboxDenialUtils.js';
/**
 * Windows-specific sandbox denial detection.
 * Extracts paths from "Access is denied" and related errors.
 */
export function parseWindowsSandboxDenials(result, cache) {
...
//# sourceMappingURL=windowsSandboxDenialUtils.js.map
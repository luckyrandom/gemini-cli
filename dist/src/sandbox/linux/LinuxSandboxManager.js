...
import { GOVERNANCE_FILES, resolveSandboxPaths, } from '../../services/sandboxManager.js';
...
export class LinuxSandboxManager {
    ...
    writeArgsToTempFile(args) {
        const tempFile = join(os.tmpdir(), `gemini-cli-bwrap-args-${Date.now()}-${Math.random().toString(36).slice(2)}.args`);

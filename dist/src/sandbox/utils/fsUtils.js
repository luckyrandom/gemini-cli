...
export async function resolveGitWorktreePaths(workspacePath) {
    try {
        ...
        if (gitStat.isFile()) {
            ...
            if (match && match[1]) {
                ...
                try {
                    ...
                    try {
                        ...
                        if (match && match[1]) {
                            ...
                            if (resolveToRealPath(worktreePath) ===
                ...
                const mainGitDir = resolveToRealPath(path.dirname(path.dirname(resolvedWorktreeGitDir)));
                return {

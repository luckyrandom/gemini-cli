...
function createMockConfig(memory = '') {
    return {
...
describe('MemoryManagerAgent', () => {
    ...
    it('should inject hierarchical memory into initial context', () => {
        const config = createMockConfig({
            ...
            project: '--- Context from: .gemini/GEMINI.md ---\nproject context\n--- End of Context from: .gemini/GEMINI.md ---',
        });
    ...
    it('should require a "request" input parameter', () => {
        const agent = MemoryManagerAgent(createMockConfig());
        const schema = agent.inputConfig.inputSchema;
...
//# sourceMappingURL=memory-manager-agent.test.js.map
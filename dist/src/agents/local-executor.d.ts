...
import { type LocalAgentDefinition, type AgentInputs, type OutputObject, type SubagentActivityEvent } from './types.js';
...
export declare class LocalAgentExecutor<TOutput extends z.ZodTypeAny> {
     ...
     */
    static create<TOutput extends z.ZodTypeAny>(definition: LocalAgentDefinition<TOutput>, context: AgentLoopContext, onActivity?: ActivityCallback): Promise<LocalAgentExecutor<TOutput>>;
    /**

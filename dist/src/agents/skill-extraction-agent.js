 ...
 */
import { z } from 'zod';
import { ACTIVATE_SKILL_TOOL_NAME, EDIT_TOOL_NAME, GLOB_TOOL_NAME, GREP_TOOL_NAME, LS_TOOL_NAME, READ_FILE_TOOL_NAME, SHELL_TOOL_NAME, WRITE_FILE_TOOL_NAME, } from '../tools/tool-names.js';
 ...
 */
function buildSystemPrompt(skillsDir) {
    return [
 ...
 * directory.
 */
export const SkillExtractionAgent = (skillsDir, sessionIndex, existingSkillsSummary) => ({
    kind: 'local',
    name: 'confucius',
...
//# sourceMappingURL=skill-extraction-agent.js.map
...
import { injectInputBlocker, removeInputBlocker, suspendInputBlocker, resumeInputBlocker, } from './inputBlocker.js';
describe('inputBlocker', () => {
    ...
    describe('injectInputBlocker', () => {
        it('should call evaluate_script with correct function parameter', async () => {
            ...
            expect(mockBrowserManager.callTool).toHaveBeenCalledWith('evaluate_script', {
        ...
        it('should be safe to call multiple times (idempotent injection)', async () => {
            ...
            expect(mockBrowserManager.callTool).toHaveBeenNthCalledWith(2, 'evaluate_script', expect.objectContaining({
                function: expect.stringContaining('__gemini_input_blocker'),
            }), undefined, true);
        });
    });
...
//# sourceMappingURL=inputBlocker.test.js.map
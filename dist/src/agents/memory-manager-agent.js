 ...
 */
import { z } from 'zod';
import { ASK_USER_TOOL_NAME, EDIT_TOOL_NAME, GLOB_TOOL_NAME, GREP_TOOL_NAME, LS_TOOL_NAME, READ_FILE_TOOL_NAME, WRITE_FILE_TOOL_NAME, } from '../tools/tool-names.js';
 ...
 */
export const MemoryManagerAgent = (config) => {
        ...
        inputConfig: {
            inputSchema: {
                ...
                properties: {
                    request: {
                        type: 'string',
                        description: 'The memory operation to perform. Examples: "Remember that I prefer tabs over spaces", "Clean up stale memories", "De-duplicate my memories", "Organize my memories".',
                    },
                },
                required: ['request'],
            },
...
//# sourceMappingURL=memory-manager-agent.js.map
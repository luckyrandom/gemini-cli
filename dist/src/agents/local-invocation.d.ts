...
import { BaseToolInvocation, type ToolResult, type ExecuteOptions } from '../tools/tools.js';
...
export declare class LocalSubagentInvocation extends BaseToolInvocation<AgentInputs, ToolResult> {
     ...
     */
    constructor(definition: LocalAgentDefinition, context: AgentLoopContext, params: AgentInputs, messageBus: MessageBus, _toolName?: string, _toolDisplayName?: string);
    /**

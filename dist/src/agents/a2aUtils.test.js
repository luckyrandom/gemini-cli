...
import { extractMessageText, extractIdsFromResponse, isTerminalState, A2AResultReassembler, AUTH_REQUIRED_MSG, normalizeAgentCard, } from './a2aUtils.js';
describe('a2aUtils', () => {
    beforeEach(() => {
        vi.clearAllMocks();
    });
    ...
    describe('normalizeAgentCard', () => {
        it('should throw if input is not an object', () => {
            ...
            expect(() => normalizeAgentCard('not an object')).toThrow('Agent card is missing.');
        });
        ...
        it('should map supportedInterfaces to additionalInterfaces with protocolBinding → transport', () => {
            ...
            const intf = normalized.additionalInterfaces?.[0];
        ...
        it('should not mutate the original card object', () => {
            ...
            expect(raw['additionalInterfaces']).toBeUndefined();
        });
    });
    describe('A2AResultReassembler', () => {
        it('should reassemble sequential messages and incremental artifacts', () => {
            ...
            expect(output).toBe('Analyzing...Processing...\n\nArtifact (Code):\nprint("Done")');
        });

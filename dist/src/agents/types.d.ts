 ...
 */
export declare const SUBAGENT_REJECTED_ERROR_PREFIX = "User rejected this operation.";
...
export declare function isSubagentProgress(obj: unknown): obj is SubagentProgress;
/**
 ...
 */
export declare function getAgentCardLoadOptions(def: RemoteAgentRef): AgentCardLoadOptions;
/**
 ...
 */
export declare function getRemoteAgentTargetUrl(def: RemoteAgentRef): string | undefined;
...
export interface BaseRemoteAgentDefinition<TOutput extends z.ZodTypeAny = z.ZodUnknown> extends BaseAgentDefinition<TOutput> {
    kind: 'remote';
...
export interface RemoteAgentDefinition<TOutput extends z.ZodTypeAny = z.ZodUnknown> extends BaseRemoteAgentDefinition<TOutput> {
    agentCardUrl?: string;
    agentCardJson?: string;
}

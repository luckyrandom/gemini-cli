 ...
 */
import { type GenerateContentResponse, type Content, type Part, type Tool, type PartListUnion } from '@google/genai';
...
export declare class InvalidStreamError extends Error {
    readonly type: 'NO_FINISH_REASON' | 'NO_RESPONSE_TEXT' | 'MALFORMED_FUNCTION_CALL' | 'UNEXPECTED_TOOL_CALL';
    constructor(message: string, type: 'NO_FINISH_REASON' | 'NO_RESPONSE_TEXT' | 'MALFORMED_FUNCTION_CALL' | 'UNEXPECTED_TOOL_CALL');
}
/**
...
export declare class GeminiChat {
    ...
    constructor(context: AgentLoopContext, systemInstruction?: string, tools?: Tool[], history?: Content[], resumedSessionData?: ResumedSessionData, onModelChanged?: ((modelId: string) => Promise<Tool[]>) | undefined);
    initialize(resumedSessionData?: ResumedSessionData, kind?: 'main' | 'subagent'): Promise<void>;

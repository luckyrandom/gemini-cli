 ...
 */
import { type PartListUnion, type GenerateContentResponse, type FunctionDeclaration, type FinishReason, type GenerateContentResponseUsageMetadata } from '@google/genai';

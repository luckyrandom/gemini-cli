...
export class LoggingContentGenerator {
    ...
    async generateContentStream(req, userPromptId, role) {
        return runInDevTraceSpan({
            ...
            return this.loggingStreamWrapper(req, stream, startTime, userPromptId, role, spanMetadata);
        });
    }
    async *loggingStreamWrapper(req, stream, startTime, userPromptId, role, spanMetadata) {
        const responses = [];

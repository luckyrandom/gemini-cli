...
import { loadApiKey, saveApiKey, clearApiKey, resetApiKeyCacheForTesting, } from './apiKeyCredentialStorage.js';
...
describe('ApiKeyCredentialStorage', () => {
    ...
    it('should save an API key and clear cache', async () => {
        ...
        expect(setCredentialsMock).toHaveBeenCalledWith(expect.objectContaining({
            serverName: 'default-api-key',

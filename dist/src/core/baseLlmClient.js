...
import { logMalformedJsonResponse, logNetworkRetryAttempt, } from '../telemetry/loggers.js';
import { MalformedJsonResponseEvent, LlmRole, NetworkRetryAttemptEvent, } from '../telemetry/types.js';
        ...
        try {
            ...
            return await retryWithBackoff(apiCall, {
                ...
                onRetry: (attempt, error, delayMs) => {
                    const actualMaxAttempts = availabilityMaxAttempts ?? maxAttempts ?? DEFAULT_MAX_ATTEMPTS;

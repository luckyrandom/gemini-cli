 ...
 */
export function getCoreSystemPrompt(config, userMemory, interactiveOverride, topicUpdateNarrationOverride) {
    return new PromptProvider().getCoreSystemPrompt(config, userMemory, interactiveOverride, topicUpdateNarrationOverride);
}
/**

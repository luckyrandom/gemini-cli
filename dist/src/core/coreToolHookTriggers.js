 ...
 */
export function extractMcpContext(invocation, config) {
 ...
 */
export async function executeToolWithHooks(invocation, toolName, signal, tool, liveOutputCallback, options, config, originalRequestName, skipBeforeHook) {

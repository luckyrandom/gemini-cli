 ...
 */
export declare function discoverJitContext(config: Config, accessedPath: string): Promise<string>;
/**
 ...
 */
export declare function appendJitContext(llmContent: string, jitContext: string): string;
/**
 ...
 */
export declare function appendJitContextToParts(llmContent: PartListUnion, jitContext: string): PartUnion[];

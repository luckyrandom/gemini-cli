...
import { type GetPromptResult, type Prompt, type ReadResourceResult, type Resource } from '@modelcontextprotocol/sdk/types.js';
...
export declare class McpClient implements McpProgressReporter {
    ...
    constructor(serverName: string, serverConfig: MCPServerConfig, workspaceContext: WorkspaceContext, cliConfig: McpContext, debugMode: boolean, clientVersion: string, onContextUpdated?: ((signal?: AbortSignal) => Promise<void>) | undefined);

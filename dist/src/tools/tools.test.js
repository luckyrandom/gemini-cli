...
import { BaseToolInvocation, DeclarativeTool, hasCycleInSchema, Kind, } from './tools.js';
...
describe('toJSON serialization', () => {
    it('DeclarativeTool.toJSON should return essential metadata', () => {
        ...
        const tool = new MyTool('name', 'display', 'desc', Kind.Read, { type: 'object' }, bus);
    ...
    it('BaseToolInvocation.toJSON should return only params', () => {
        const bus = createMockMessageBus();
        const params = { foo: 'bar' };
        class MyInvocation extends BaseToolInvocation {
            getDescription() {
                return 'desc';
            }
            async execute() {

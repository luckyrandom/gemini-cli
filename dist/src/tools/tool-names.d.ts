...
export declare const TRACKER_ADD_DEPENDENCY_TOOL_NAME = "tracker_add_dependency";
 ...
 */
export declare const PLAN_MODE_TOOLS: readonly ["glob", "grep_search", "read_file", "list_directory", "google_web_search", "ask_user", "activate_skill", "get_internal_docs", "update_topic", "codebase_investigator", "cli_help", "read_mcp_resource", "list_mcp_resources"];
/**

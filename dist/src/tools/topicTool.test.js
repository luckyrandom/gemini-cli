...
import { UPDATE_TOPIC_TOOL_NAME, TOPIC_PARAM_TITLE, TOPIC_PARAM_SUMMARY, TOPIC_PARAM_STRATEGIC_INTENT, } from './definitions/base-declarations.js';
describe('TopicState', () => {
    let state;
    beforeEach(() => {
...
describe('UpdateTopicTool', () => {
    ...
    let mockConfig;
    beforeEach(() => {
        mockMessageBus = new MessageBus(vi.mocked({}));
    ...
    it('should update TopicState and include strategic intent on execute', async () => {
        ...
        expect(result.llmContent).toContain('Topic summary: The goal is to implement X. Previously we did Y.');
...
//# sourceMappingURL=topicTool.test.js.map
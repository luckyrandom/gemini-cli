...
describe('LSTool', () => {
    ...
    describe('execute', () => {
        ...
        it('should respect gitignore patterns', async () => {
            ...
            expect(result.returnDisplay).toEqual(expect.objectContaining({ summary: 'Found 2 item(s). (2 ignored)' }));
        });
        it('should respect geminiignore patterns', async () => {
            ...
            expect(result.llmContent).toContain('file1.txt');
            expect(result.llmContent).not.toContain('file2.log');
            expect(result.returnDisplay).toEqual(expect.objectContaining({ summary: 'Found 2 item(s). (1 ignored)' }));
        });

...
import { READ_MANY_FILES_TOOL_NAME, READ_MANY_FILES_DISPLAY_NAME, } from './tool-names.js';
...
import { discoverJitContext, JIT_CONTEXT_PREFIX, JIT_CONTEXT_SUFFIX, } from './jit-context.js';
/**
...
export class ReadManyFilesTool extends BaseDeclarativeTool {
    ...
    constructor(config, messageBus) {
        super(ReadManyFilesTool.Name, READ_MANY_FILES_DISPLAY_NAME, READ_MANY_FILES_DEFINITION.base.description, Kind.Read, READ_MANY_FILES_DEFINITION.base.parametersJsonSchema, messageBus, true, // isOutputMarkdown
        false);
        this.config = config;
    }

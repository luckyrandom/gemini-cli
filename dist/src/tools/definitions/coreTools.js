 ...
 */
export function getToolSet(modelId) {
...
export const RIP_GREP_DEFINITION = {
    get base() {
...
export const UPDATE_TOPIC_DEFINITION = {
    get base() {
...
export function getShellDefinition(enableInteractiveShell, enableEfficiency, enableToolSandboxing = false) {
    return {

...
export declare function getShellDefinition(enableInteractiveShell: boolean, enableEfficiency: boolean, enableToolSandboxing?: boolean): ToolDefinition;
export declare function getExitPlanModeDefinition(): ToolDefinition;
export declare function getActivateSkillDefinition(skillNames: string[]): ToolDefinition;

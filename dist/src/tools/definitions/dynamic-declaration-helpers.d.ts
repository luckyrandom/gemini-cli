 ...
 */
export declare function getShellDeclaration(enableInteractiveShell: boolean, enableEfficiency: boolean, enableToolSandboxing?: boolean): FunctionDeclaration;
/**
 ...
 */
export declare function getActivateSkillDeclaration(skillNames: string[]): FunctionDeclaration;
/**

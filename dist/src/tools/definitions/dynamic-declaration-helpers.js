 ...
 */
export function getShellDeclaration(enableInteractiveShell, enableEfficiency, enableToolSandboxing = false) {
    return {
 ...
 */
export function getUpdateTopicDeclaration() {
    return {

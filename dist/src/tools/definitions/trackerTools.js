 ...
 */
import { TRACKER_CREATE_TASK_TOOL_NAME, TRACKER_UPDATE_TASK_TOOL_NAME, TRACKER_GET_TASK_TOOL_NAME, TRACKER_LIST_TASKS_TOOL_NAME, TRACKER_ADD_DEPENDENCY_TOOL_NAME, TRACKER_VISUALIZE_TOOL_NAME, } from '../tool-names.js';
export const TRACKER_CREATE_TASK_DEFINITION = {
    base: {
...
export const TRACKER_UPDATE_TASK_DEFINITION = {
    base: {
...
export const TRACKER_GET_TASK_DEFINITION = {
    base: {
...
export const TRACKER_LIST_TASKS_DEFINITION = {
    base: {
...
export const TRACKER_ADD_DEPENDENCY_DEFINITION = {
    base: {
...
export const TRACKER_VISUALIZE_DEFINITION = {
    base: {

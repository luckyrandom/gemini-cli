...
describe('McpClientManager', () => {
    ...
    const setupManager = (manager) => {
        manager.setMainRegistries({
            toolRegistry,
            promptRegistry: mockConfig.getPromptRegistry(),
            resourceRegistry: mockConfig.getResourceRegistry(),
        });
        return manager;
    };
    ...
    describe('findResourceByUri', () => {
        it('should find resource by exact URI match', () => {
            ...
            mockConfig.getResourceRegistry.mockReturnValue(mockResourceRegistry);
            const manager = setupManager(new McpClientManager('0.0.1', mockConfig));
        ...
        it('should try ResourceRegistry.findResourceByUri first', () => {
            ...
            expect(mockResourceRegistry.findResourceByUri).toHaveBeenCalledWith('test-server:test://resource1');

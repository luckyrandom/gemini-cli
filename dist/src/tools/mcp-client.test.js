...
import { ErrorCode, McpError, PromptListChangedNotificationSchema, ResourceListChangedNotificationSchema, ToolListChangedNotificationSchema, ProgressNotificationSchema, } from '@modelcontextprotocol/sdk/types.js';
import { WorkspaceContext } from '../utils/workspaceContext.js';
import { connectToMcpServer, createTransport, hasNetworkTransport, isEnabled, McpClient, populateMcpServerCommand, discoverPrompts, } from './mcp-client.js';
    ...
    describe('McpClient', () => {
        ...
        it('should return empty array for discoverPrompts on MethodNotFound error without diagnostic', async () => {
            const mockedClient = {
                ...
                listPrompts: vi
                    .fn()
                    .mockRejectedValue(new McpError(ErrorCode.MethodNotFound, 'Method not supported')),
            };
            const result = await discoverPrompts('test-server', mockedClient, MOCK_CONTEXT);

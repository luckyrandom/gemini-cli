 ...
 */
export declare function checkPolicy(toolCall: ValidatingToolCall, config: Config, subagent?: string): Promise<CheckResult>;
/**
 * Evaluates the outcome of a user confirmation and dispatches
 * policy config updates.
 */
export declare function updatePolicy(tool: AnyDeclarativeTool, outcome: ToolConfirmationOutcome, confirmationDetails: SerializableConfirmationDetails | undefined, context: AgentLoopContext, messageBus: MessageBus, toolInvocation?: AnyToolInvocation): Promise<void>;

 ...
 */
export function isSafeRegExp(pattern) {
    try {
 ...
 */
export function buildParamArgsPattern(paramName, value) {
 ...
 */
export function buildFilePathArgsPattern(filePath) {
 ...
 */
export function buildDirPathArgsPattern(dirPath) {
 ...
 */
export function buildPatternArgsPattern(pattern) {

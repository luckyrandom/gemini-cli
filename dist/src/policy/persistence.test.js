...
describe('createPolicyUpdater', () => {
    ...
    it('should persist policy when persist flag is true', async () => {
        ...
        const content = memfs.readFileSync(policyFile, 'utf-8');
...
`;
    ...
    it('should include mcpName if provided', async () => {
        ...
        await vi.advanceTimersByTimeAsync(100);
        const writtenContent = memfs.readFileSync(policyFile, 'utf-8');
    ...
    it('should persist to workspace when persistScope is workspace', async () => {
        ...
        vi.spyOn(mockStorage, 'getWorkspaceAutoSavedPolicyPath').mockReturnValue(policyFile);
        await messageBus.publish({
            type: MessageBusType.UPDATE_POLICY,
            toolName: 'test_tool',
            persist: true,

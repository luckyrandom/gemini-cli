...
describe('Workspace-Level Policies', () => {
    beforeEach(async () => {
        ...
        vi.spyOn(Storage, 'getUserPoliciesDir').mockReturnValue(nodePath.resolve('/mock/user/policies'));
        vi.spyOn(Storage, 'getSystemPoliciesDir').mockReturnValue(nodePath.resolve('/mock/system/policies'));

...
import { ApprovalMode, type PolicyEngineConfig, type PolicyRule, type PolicySettings, type SafetyCheckerRule } from './types.js';
 ...
 */
export declare function getPolicyDirectories(defaultPoliciesDir?: string, policyPaths?: string[], workspacePoliciesDir?: string, adminPolicyPaths?: string[]): string[];
/**
 ...
 */
export declare function getPolicyTier(dir: string, context: {
...
export declare function createPolicyEngineConfig(settings: PolicySettings, approvalMode: ApprovalMode, defaultPoliciesDir?: string, interactive?: boolean): Promise<PolicyEngineConfig>;

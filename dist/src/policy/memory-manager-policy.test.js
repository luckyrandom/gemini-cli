...
describe('Memory Manager Policy', () => {
    ...
    it('should allow save_memory to read ~/.gemini/GEMINI.md', async () => {
        ...
        const result = await engine.check(toolCall, undefined, undefined, 'save_memory');
    ...
    it('should fall through to global allow rule for other agents accessing ~/.gemini/', async () => {
        ...
        const result = await engine.check(toolCall, undefined, undefined, 'other_agent');
...
//# sourceMappingURL=memory-manager-policy.test.js.map
...
describe('OAuthUtils', () => {
    ...
    describe('discoverOAuthConfig', () => {
        ...
        it('should accept equivalent root resources with and without trailing slash', async () => {
            ...
            await expect(OAuthUtils.discoverOAuthConfig('https://example.com')).resolves.toEqual({
                authorizationUrl: 'https://auth.example.com/authorize',
                issuer: 'https://auth.example.com',
                tokenUrl: 'https://auth.example.com/token',
                scopes: ['read', 'write'],
    ...
    describe('discoverOAuthFromWWWAuthenticate', () => {
        ...
        it('should accept equivalent root resources with and without trailing slash', async () => {
            ...
            const result = await OAuthUtils.discoverOAuthFromWWWAuthenticate('Bearer realm="example", resource_metadata="https://example.com/.well-known/oauth-protected-resource"', 'https://example.com/');

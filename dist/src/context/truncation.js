 ...
 */
import { estimateTokenCountSync, ASCII_TOKENS_PER_CHAR, NON_ASCII_TOKENS_PER_CHAR, } from '../utils/tokenCalculation.js';
 ...
 */
export function estimateCharsFromTokens(text, targetTokens) {
    if (text.length === 0)
        return 0;
    ...
    const avgTokensPerChar = asciiRatio * ASCII_TOKENS_PER_CHAR +
 ...
 */
export function truncateProportionally(str, targetChars, prefix, headRatio = 0.2) {
 ...
 */
export function normalizeFunctionResponse(part, ratio, headRatio = 0.2, savedPath, intentSummary) {

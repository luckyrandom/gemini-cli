 ...
 */
import { LlmRole, ToolOutputTruncatedEvent, logToolOutputTruncated, debugLogger, } from '../index.js';
...
import { truncateProportionally, TOOL_TRUNCATION_PREFIX, MIN_TARGET_TOKENS, estimateCharsFromTokens, normalizeFunctionResponse, } from './truncation.js';
...
export class ToolOutputDistillationService {
    ...
    geminiClient;
    promptId;
    constructor(config, geminiClient, promptId) {
        this.config = config;
    ...
    async performDistillation(toolName, callId, content, originalContentLength, threshold) {
        ...
        if (originalContentLength > summarizationThresholdChars &&
    ...
    truncateContentStructurally(content, ratio, savedPath, intentSummary) {
        ...
        return content.map((part) => {
            ...
            if (part.functionResponse) {
                return normalizeFunctionResponse(part, ratio, 0.2, // default headRatio
                savedPath, intentSummary);
            }
            return part;
        });
    }
...
${stringifiedContent.slice(0, maxPreviewLen)}...`;
            ...
            debugLogger.debug('Failed to generate intent summary for truncated output:', e instanceof Error ? e.message : String(e));
            return undefined;
        }
    }
}
//# sourceMappingURL=toolDistillationService.js.map
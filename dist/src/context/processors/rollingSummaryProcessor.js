...
export const RollingSummaryProcessorOptionsSchema = {
    type: 'object',
    properties: {
        target: {
            type: 'string',
...
export function createRollingSummaryProcessor(id, env, options) {
    const generateRollingSummary = async (nodes) => {
        let transcript = '';
...
//# sourceMappingURL=rollingSummaryProcessor.js.map
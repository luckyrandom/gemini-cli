...
export const BlobDegradationProcessorOptionsSchema = {
    type: 'object',
    properties: {},
    required: [],
};
export function createBlobDegradationProcessor(id, env) {
    return {
        id,
        ...
        process: async ({ targets }) => {
            ...
            if (sessionId) {
                blobOutputsDir = path.join(blobOutputsDir, `session-${sanitizeFilenamePart(sessionId)}`);
            }
...
//# sourceMappingURL=blobDegradationProcessor.js.map
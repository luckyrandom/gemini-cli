...
import { createMockProcessArgs, createMockEnvironment, createDummyNode, createDummyToolNode, createMockLlmClient, } from '../testing/contextTestUtils.js';
describe('NodeDistillationProcessor', () => {
    it('should trigger summarization via LLM for long text parts', async () => {
        ...
        // 1. User Prompt
        const compressedPrompt = result[0];

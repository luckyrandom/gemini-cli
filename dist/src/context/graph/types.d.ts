...
export type NodeType = 'USER_PROMPT' | 'SYSTEM_EVENT' | 'AGENT_THOUGHT' | 'TOOL_EXECUTION' | 'AGENT_YIELD' | 'SNAPSHOT' | 'ROLLING_SUMMARY' | 'MASKED_TOOL' | 'TASK' | 'EPISODE';
...
export type SemanticPart = SemanticTextPart | SemanticInlineDataPart | SemanticFileDataPart | SemanticRawPart;
/**
 * Trigger Nodes
...
export type ConcreteNode = UserPrompt | SystemEvent | AgentThought | ToolExecution | MaskedTool | AgentYield | Snapshot | RollingSummary;
/**
 * Logical Nodes

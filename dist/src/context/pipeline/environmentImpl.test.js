...
describe('ContextEnvironmentImpl', () => {
    it('should initialize with defaults correctly', () => {
        ...
        const env = new ContextEnvironmentImpl(mockLlmClient, 'mock-session', 'mock-prompt', '/tmp/trace', '/tmp/temp', tracer, 4, eventBus);
...
//# sourceMappingURL=environmentImpl.test.js.map
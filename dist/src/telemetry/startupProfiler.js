        ...
        for (const phase of this.phases.values()) {
            ...
            if (measure && phase.cpuUsage) {
                startupPhases.push({
                    ...
                    start_time_usec: Math.round((performance.timeOrigin + measure.startTime) * 1000),
                    end_time_usec: Math.round((performance.timeOrigin + measure.startTime + measure.duration) *
                        1000),
                });
            }
        }

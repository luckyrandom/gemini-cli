...
import { recordMemoryUsage, recordCpuUsage, isPerformanceMonitoringActive, } from './metrics.js';
    ...
    describe('MemoryMonitor Class', () => {
        ...
        describe('takeSnapshot', () => {
            it('should take a memory snapshot and record metrics when performance monitoring is active', () => {
                ...
                expect(mockRecordCpuUsage).toHaveBeenCalledWith(mockConfig, expect.any(Number), {
                    component: 'test_context',
                });
            });

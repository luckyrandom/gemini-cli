...
describe('Telemetry Metrics', () => {
    ...
    let recordOnboardingSuccessModule;
    ...
    let recordInvalidChunkModule;
    let recordBrowserAgentConnectionModule;
    let recordBrowserAgentToolDiscoveryModule;
    let recordBrowserAgentVisionStatusModule;
    let recordBrowserAgentTaskOutcomeModule;
    let recordBrowserAgentCleanupModule;
    beforeEach(async () => {
        vi.resetModules();
    ...
    describe('Browser Agent Metrics', () => {
        ...
        describe('recordBrowserAgentToolDiscovery', () => {
            ...
            it('records tool count and missing tools', () => {
                ...
                mockCounterAddFn.mockClear();
                mockHistogramRecordFn.mockClear();
                recordBrowserAgentToolDiscoveryModule(mockConfig, 3, ['click', 'type'], 'isolated');
                expect(mockHistogramRecordFn).toHaveBeenCalledWith(3, {
                    'session.id': 'test-session-id',
                    'installation.id': 'test-installation-id',
                    'user.email': 'test@example.com',

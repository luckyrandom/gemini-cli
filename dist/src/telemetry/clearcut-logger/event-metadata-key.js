...
(function (EventMetadataKey) {
    ...
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_STARTUP_PHASES"] = 172] = "GEMINI_CLI_STARTUP_PHASES";
    // Logs the OS platform for startup stats.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_STARTUP_OS_PLATFORM"] = 173] = "GEMINI_CLI_STARTUP_OS_PLATFORM";
    // Logs the OS release for startup stats.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_STARTUP_OS_RELEASE"] = 174] = "GEMINI_CLI_STARTUP_OS_RELEASE";
    // Logs whether the CLI is running in docker for startup stats.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_STARTUP_IS_DOCKER"] = 175] = "GEMINI_CLI_STARTUP_IS_DOCKER";
    // ==========================================================================
    ...
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_SYSTEM_INSTRUCTIONS"] = 167] = "GEMINI_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_SYSTEM_INSTRUCTIONS";
    // Logs the token count for tool definitions.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_TOOL_DEFINITIONS"] = 168] = "GEMINI_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_TOOL_DEFINITIONS";
    // Logs the token count for conversation history.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_HISTORY"] = 169] = "GEMINI_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_HISTORY";
    // Logs the token count for tool calls (JSON map of tool name to tokens).
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_TOOL_CALLS"] = 170] = "GEMINI_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_TOOL_CALLS";
    // Logs the token count from MCP servers (tool definitions + tool inputs/outputs).
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_MCP_SERVERS"] = 171] = "GEMINI_CLI_API_RESPONSE_CONTEXT_BREAKDOWN_MCP_SERVERS";
    // ==========================================================================
    ...
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_GH_EVENT_NAME"] = 176] = "GEMINI_CLI_GH_EVENT_NAME";
    // Logs the Pull Request number if the workflow is operating on a PR.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_GH_PR_NUMBER"] = 177] = "GEMINI_CLI_GH_PR_NUMBER";
    // Logs the Issue number if the workflow is operating on an Issue.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_GH_ISSUE_NUMBER"] = 178] = "GEMINI_CLI_GH_ISSUE_NUMBER";
    // Logs a custom tracking string (e.g. a comma-separated list of issue IDs for scheduled batches).
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_GH_CUSTOM_TRACKING_ID"] = 179] = "GEMINI_CLI_GH_CUSTOM_TRACKING_ID";
    // ==========================================================================
    ...
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_START_SESSION_WORKTREE_ACTIVE"] = 191] = "GEMINI_CLI_START_SESSION_WORKTREE_ACTIVE";
    ...
    EventMetadataKey[EventMetadataKey["CONSECA_POLICY_GENERATION"] = 159] = "CONSECA_POLICY_GENERATION";
    // Logs the verdict event.
    EventMetadataKey[EventMetadataKey["CONSECA_VERDICT"] = 160] = "CONSECA_VERDICT";
    // Logs the generated policy content.
    EventMetadataKey[EventMetadataKey["CONSECA_GENERATED_POLICY"] = 161] = "CONSECA_GENERATED_POLICY";
    // Logs the verdict result (e.g. ALLOW/BLOCK).
    EventMetadataKey[EventMetadataKey["CONSECA_VERDICT_RESULT"] = 162] = "CONSECA_VERDICT_RESULT";
    // Logs the verdict rationale.
    EventMetadataKey[EventMetadataKey["CONSECA_VERDICT_RATIONALE"] = 163] = "CONSECA_VERDICT_RATIONALE";
    // Logs the trusted content used.
    EventMetadataKey[EventMetadataKey["CONSECA_TRUSTED_CONTENT"] = 164] = "CONSECA_TRUSTED_CONTENT";
    // Logs the user prompt for Conseca events.
    EventMetadataKey[EventMetadataKey["CONSECA_USER_PROMPT"] = 165] = "CONSECA_USER_PROMPT";
    // Logs the error message for Conseca events.
    EventMetadataKey[EventMetadataKey["CONSECA_ERROR"] = 166] = "CONSECA_ERROR";
    // ==========================================================================
    // Network Retry Event Keys
    // ==========================================================================
    // Logs the attempt number for a network retry.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_NETWORK_RETRY_ATTEMPT_NUMBER"] = 180] = "GEMINI_CLI_NETWORK_RETRY_ATTEMPT_NUMBER";
    // Logs the delay in milliseconds for a network retry.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_NETWORK_RETRY_DELAY_MS"] = 181] = "GEMINI_CLI_NETWORK_RETRY_DELAY_MS";
    // Logs the error type for a network retry.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_NETWORK_RETRY_ERROR_TYPE"] = 182] = "GEMINI_CLI_NETWORK_RETRY_ERROR_TYPE";
    // ==========================================================================
    // Billing / AI Credits Event Keys
    // ==========================================================================
    // Logs the model associated with a billing event.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_BILLING_MODEL"] = 185] = "GEMINI_CLI_BILLING_MODEL";
    // Logs the number of AI credits consumed in a request.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_BILLING_CREDITS_CONSUMED"] = 186] = "GEMINI_CLI_BILLING_CREDITS_CONSUMED";
    // Logs the remaining AI credits after a request.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_BILLING_CREDITS_REMAINING"] = 187] = "GEMINI_CLI_BILLING_CREDITS_REMAINING";
    // Logs the overage option selected by the user (e.g. use_credits, use_fallback, manage, stop).
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_BILLING_SELECTED_OPTION"] = 188] = "GEMINI_CLI_BILLING_SELECTED_OPTION";
    // Logs the user's credit balance when the overage menu was shown.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_BILLING_CREDIT_BALANCE"] = 189] = "GEMINI_CLI_BILLING_CREDIT_BALANCE";
    // Logs the source of a credit purchase click (e.g. overage_menu, empty_wallet_menu, manage).
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_BILLING_PURCHASE_SOURCE"] = 190] = "GEMINI_CLI_BILLING_PURCHASE_SOURCE";
    // ==========================================================================
    // Gemini Enterprise (GE) Event Keys
    // ==========================================================================
    // Logs the start of the onboarding process.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_ONBOARDING_START"] = 192] = "GEMINI_CLI_ONBOARDING_START";
    // Logs the user tier for onboarding success events.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_ONBOARDING_USER_TIER"] = 193] = "GEMINI_CLI_ONBOARDING_USER_TIER";
    // Logs the duration of the onboarding process in milliseconds.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_ONBOARDING_DURATION_MS"] = 194] = "GEMINI_CLI_ONBOARDING_DURATION_MS";
    // ==========================================================================
    // Browser Agent Event Keys
    // ==========================================================================
    // Logs the browser agent session mode (persistent, isolated, existing).
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_BROWSER_AGENT_SESSION_MODE"] = 195] = "GEMINI_CLI_BROWSER_AGENT_SESSION_MODE";
    // Logs whether the browser agent ran in headless mode.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_BROWSER_AGENT_HEADLESS"] = 196] = "GEMINI_CLI_BROWSER_AGENT_HEADLESS";
    // Logs whether the browser agent operation was successful.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_BROWSER_AGENT_SUCCESS"] = 197] = "GEMINI_CLI_BROWSER_AGENT_SUCCESS";
    // Logs the error type for a browser agent connection failure.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_BROWSER_AGENT_ERROR_TYPE"] = 198] = "GEMINI_CLI_BROWSER_AGENT_ERROR_TYPE";
    // Logs the duration in milliseconds for a browser agent operation.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_BROWSER_AGENT_DURATION_MS"] = 199] = "GEMINI_CLI_BROWSER_AGENT_DURATION_MS";
    // Logs whether vision mode was enabled for the browser agent.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_BROWSER_AGENT_VISION_ENABLED"] = 200] = "GEMINI_CLI_BROWSER_AGENT_VISION_ENABLED";
    // Logs the reason vision mode was disabled for the browser agent.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_BROWSER_AGENT_VISION_DISABLED_REASON"] = 201] = "GEMINI_CLI_BROWSER_AGENT_VISION_DISABLED_REASON";
    // Logs the number of tools discovered from the MCP server.
    EventMetadataKey[EventMetadataKey["GEMINI_CLI_BROWSER_AGENT_TOOL_COUNT"] = 202] = "GEMINI_CLI_BROWSER_AGENT_TOOL_COUNT";

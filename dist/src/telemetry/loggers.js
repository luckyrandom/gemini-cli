...
export function logNetworkRetryAttempt(config, event) {
...
export function logOnboardingStart(config, event) {
...
export function logOnboardingSuccess(config, event) {
...
// ==========================================================================
export function logBrowserAgentConnection(config, durationMs, attributes) {
...
export function logBrowserAgentVisionStatus(config, attributes) {
...
export function logBrowserAgentTaskOutcome(config, attributes) {
...
export function logBrowserAgentCleanup(config, durationMs, attributes) {

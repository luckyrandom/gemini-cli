...
import { type ApiErrorEvent, type ApiRequestEvent, type ApiResponseEvent, type FileOperationEvent, type IdeConnectionEvent, type StartSessionEvent, type ToolCallEvent, type UserPromptEvent, type FlashFallbackEvent, type NextSpeakerCheckEvent, type LoopDetectedEvent, type LoopDetectionDisabledEvent, type SlashCommandEvent, type RewindEvent, type ConversationFinishedEvent, type ChatCompressionEvent, type MalformedJsonResponseEvent, type InvalidChunkEvent, type ContentRetryEvent, type ContentRetryFailureEvent, type NetworkRetryAttemptEvent, type RipgrepFallbackEvent, type ToolOutputTruncatedEvent, type ModelRoutingEvent, type ExtensionDisableEvent, type ExtensionEnableEvent, type ExtensionUninstallEvent, type ExtensionInstallEvent, type ModelSlashCommandEvent, type EditStrategyEvent, type EditCorrectionEvent, type AgentStartEvent, type AgentFinishEvent, type RecoveryAttemptEvent, type WebFetchFallbackAttemptEvent, type ExtensionUpdateEvent, type ApprovalModeSwitchEvent, type ApprovalModeDurationEvent, type HookCallEvent, type StartupStatsEvent, type LlmLoopCheckEvent, type PlanExecutionEvent, type ToolOutputMaskingEvent, type KeychainAvailabilityEvent, type TokenStorageInitializationEvent, type OnboardingStartEvent, type OnboardingSuccessEvent } from './types.js';
...
export declare function logNetworkRetryAttempt(config: Config, event: NetworkRetryAttemptEvent): void;
...
export declare function logOnboardingStart(config: Config, event: OnboardingStartEvent): void;
export declare function logOnboardingSuccess(config: Config, event: OnboardingSuccessEvent): void;
export declare function logBillingEvent(config: Config, event: BillingTelemetryEvent): void;
export declare function logBrowserAgentConnection(config: Config, durationMs: number, attributes: {
...
export declare function logBrowserAgentVisionStatus(config: Config, attributes: {
    enabled: boolean;
    disabled_reason?: 'no_visual_model' | 'missing_visual_tools' | 'blocked_auth_type';
}): void;
export declare function logBrowserAgentTaskOutcome(config: Config, attributes: {
    success: boolean;
    session_mode: 'persistent' | 'isolated' | 'existing';
...
export declare function logBrowserAgentCleanup(config: Config, durationMs: number, attributes: {
    session_mode: 'persistent' | 'isolated' | 'existing';
    success: boolean;
}): void;

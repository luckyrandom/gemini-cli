 ...
 */
import { ValueType, type Attributes, type Counter, type Histogram } from '@opentelemetry/api';
 ...
 */
export declare function recordOnboardingSuccess(config: Config, userTier?: string, durationMs?: number): void;
/**
...
export declare function recordRetryAttemptMetrics(config: Config, attributes: {
    model: string;
    attempt: number;
}): void;
/**
...
export declare function recordEventLoopDelay(config: Config, delayMs: number, attributes: MetricDefinitions[typeof EVENT_LOOP_DELAY]['attributes']): void;
...
export declare function recordBrowserAgentConnection(config: Config, durationMs: number, attributes: {
    session_mode: 'persistent' | 'isolated' | 'existing';
    headless: boolean;
    success: boolean;
    error_type?: 'profile_locked' | 'timeout' | 'connection_refused' | 'unknown';
...
export declare function recordBrowserAgentToolDiscovery(config: Config, toolCount: number, missingSemanticTools: string[], sessionMode: 'persistent' | 'isolated' | 'existing'): void;
export declare function recordBrowserAgentVisionStatus(config: Config, attributes: {
    enabled: boolean;
    disabled_reason?: 'no_visual_model' | 'missing_visual_tools' | 'blocked_auth_type';
}): void;
export declare function recordBrowserAgentTaskOutcome(config: Config, attributes: {
    success: boolean;
    session_mode: 'persistent' | 'isolated' | 'existing';
    vision_enabled: boolean;
    headless: boolean;
...
export declare function recordBrowserAgentCleanup(config: Config, durationMs: number, attributes: {
    session_mode: 'persistent' | 'isolated' | 'existing';
    success: boolean;
}): void;
export {};

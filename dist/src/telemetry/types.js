...
(function (LoopType) {
    ...
    LoopType["TOOL_CALL_LOOP"] = "consecutive_identical_tool_calls";
    LoopType["CONTENT_CHANTING_LOOP"] = "chanting_identical_sentences";
})(LoopType || (LoopType = {}));
...
export class NetworkRetryAttemptEvent {
    'event.name';
    'event.timestamp';
    attempt;
    max_attempts;
...
export class OnboardingStartEvent {
    'event.name';
    'event.timestamp';
    constructor() {
...
export class OnboardingSuccessEvent {
    'event.name';
    'event.timestamp';
    userTier;
    duration_ms;
